...
if ( $companyId > 0 ) {
    ...
    $company_customer_app_url = '';
    $company_driver_app_url   = '';
...
DEFINE( 'ALTER_DB_NAME', '' );
DEFINE( 'ALTER_DB_USER', '' );
DEFINE( 'ALTER_DB_PWD', '' );
DEFINE( 'ALTER_DB_HOST', '' );
/****** payment Gateway Curl Process url *******/
DEFINE( 'PAYMENT_REDIRECT_HOST', '' );
DEFINE( 'CRM_HOST_URL', '' );
DEFINE( 'CRM_PORT', '' );
DEFINE( 'CRM_PAYMENT_AUTHENTICATION_ACCESSKEY','');
DEFINE( 'CRM_UPDATE_ENABLE',0);
define( 'CLOUD_EMAIL_VERIFICATION','');

/****** Billing Information **********/
DEFINE( 'CLOUD_SERVICE_TAX','' );
DEFINE( 'CLOUD_INVOICE_DUE_DAY', '' );
DEFINE( 'REPLACE_CONTACT_URL', "##CONTACT_URL##" );
DEFINE( 'REPLACE_PRIVACY_URL', "##PRIVACY_URL##" );
DEFINE( 'REPLACE_FAQ_URL', "##FAQ_URL##" );
if ( !empty( $expiryTime ) && $expiryTime < $cTsatmp && CHECK_EXPIRY != 0 ) {
