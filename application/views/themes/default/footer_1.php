...
<footer class="footer">
   ...
   <ul>
      <li>
         <a target="_blank" href="<?php echo $home_array['facebook_follow_link']; ?>" title="Facebook" class="face_footer"></a>
      </li>
      <li>
         <a target="_blank" href="<?php echo $home_array['twitter_follow_link']; ?>" title="twitter" class="tweet_footer"></a>
      </li>
      <li>
         <a target="_blank" href="<?php echo $home_array['google_follow_link']; ?>" title="google plus" class="gplus_footer"></a>
      </li>
   </ul>
</div>
