...
<div class="container_content fl clr">
	...
	<td style="float:right"><div class="new_button"><input type="button" value="<?php echo __('download_sample'); ?>" onclick="window.location='<?php echo URL_BASE."public/uploads/sample/driver_sample.xlsx"; ?>'" /></div>
</td>	          
	</tr>	
