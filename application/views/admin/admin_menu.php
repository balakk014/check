...
<?php
    ...
    } else if ($action == 'taxi' || $action == 'today_unassigned_taxi' || $action == 'taxisearch' || $action == 'availabilitytaxi' || $action == 'availabilitytaxisearch' || $action == "taxiinfo" || $action == "taxilogs" || $action == 'driver' || $action == 'unassign_driver' || $action == 'driversearch' || $action == 'availabilitydriver' || $action == 'availabilitydriversearch' || $action == 'driverinfo' || $action == 'driverlogs' || $action == 'motor' || $action == 'motorsearch' || $action == 'model' || $action == 'modelsearch' || $action == 'modelinfo' || $action == 'assigntaxi' || $action == 'assigntaxisearch' || $action == 'mile' || $action == 'walletrequests' || $action == 'ratingdrivers' || $action == 'taxi_import' || $action == 'driver_import') {
    $car_setting = 'active';
    if ($action == 'taxi' || $action == 'today_unassigned_taxi' || $action == 'taxisearch' || $action == 'availabilitytaxi' || $action == 'availabilitytaxisearch' || $action == "taxiinfo" || $action == "taxilogs" || $action == 'taxi_import') {
    $manage_taxi = 'active';
    } else if ($action == 'driver' || $action == 'unassign_driver' || $action == 'driversearch' || $action == 'availabilitydriver' || $action == 'availabilitydriversearch' || $action == 'driverinfo' || $action == 'driverlogs' || $action == 'walletrequests' || $action == 'ratingdrivers'|| $action == 'driver_import') {
...
<div id="sidebar" <?php if ($controller != "tdispatch") { ?>class="test"<?php } else { ?>class="dispatch_sidebar"<?php } ?> >
    ...
    <nav class="menu">
        <ul class="sidebar-menu">
                ...
                <ul class="treeview-menu menu_drop_down">
                    ...
                    <li class="treeview <?php if ($manage_taxi) { echo $manage_taxi; } ?>">
                        ...
                        <ul class="treeview-menu menu_drop_down">
                            ...
                            <li>
                                <a href="<?php echo URL_BASE; ?>add/taxi_import" class="lastmenu <?php if ($url == '/add/taxi_import') { echo 'current';} ?>" title="<?php echo __('taxi_import'); ?>">
                                <?php echo __('taxi_import'); ?>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview <?php if ($manage_driver) { echo $manage_driver; } ?>">
                        ...
                        <ul class="treeview-menu menu_drop_down">
                            ...
                            <li>
                                <a href="<?php echo URL_BASE; ?>add/driver_import" class="lastmenu <?php if ($url == '/add/driver_import') { echo 'current'; } ?>" title="<?php echo __('driver_import'); ?>">
                                <?php echo __('driver_import'); ?>
                                </a>
                            </li>
            ...
            <!-- Payments Starts --->	
            <?php if ($_SESSION['user_type'] == 'A') { ?>
            <li class=" treeview <?php if($manage_payments) { echo $manage_payments; } ?>">
            ...
            <!--- End ----------->
            <?php if($_SESSION['user_type'] =='A') { ?>
            <li class="treeview <?php if($manage_cloud_account) { echo $manage_cloud_account; } ?>">
                ...
                <ul class="treeview-menu menu_drop_down">
                   <?php /* <li><a href="<?php echo URL_BASE;?>package/home" class="lastmenu <?php if($url == '/package/home') { echo 'current'; } ?>"  title=""><?php echo __('home');?></a></li> */ ?>
                    <li class="treeview <?php if ($manage_cloud_setting) {
                        ...
                        <ul class="treeview-menu menu_drop_down">
                            <?php /*<li><a href="<?php echo URL_BASE;?>package/account" class="lastmenu <?php if($url == '/package/account') { echo 'current'; } ?>"  title=""><?php echo __('account');?></a></li>*/ ?>
