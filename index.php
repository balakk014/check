...
/**
 * The directory in which the Kohana public folder are located. The public
 * directory must contain the classes/kohana.php file.
 *
 * @link http://kohanaframework.org/guide/about.install#system
 */
$domainname='uploads';//Need to add client folder name here
...
unset($application, $modules, $system,$customlangpath);
